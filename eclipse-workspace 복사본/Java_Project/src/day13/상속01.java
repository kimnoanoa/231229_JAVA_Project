...
public class 상속01 {
	...
	public static void main(String[] args) {
		// 상속 : 부모의 것을 자식에게 물려주는 일
		/* 상속 : 멤버변수, 멤버메서드만 물려줄 수 있음
		 * 클래스의 확장개념.
		 * 상속을 하는 아유 : 재사용을 해 중복코드를 줄이고 유지보수를 쉽게 하기 위해.
		 ...
		 *  - 접근제한자 private 이면 자식클래스에서 접근불가능
		...
		b.setB(200);
		b.setC(300);
		b.num = 1000; // 접근제어자가 protexted이기 때문에 접근가능
		b.print();
...
class B extends A{ // 자식클래스
	...
	public void print() {
		...
		super.print(); //부모의 프린트 메서드를 호출하여 출력
