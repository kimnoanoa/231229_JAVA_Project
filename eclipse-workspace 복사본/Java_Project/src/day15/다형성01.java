 ...
 * - 하나의 코드가 여러 자료 (객체) 혀으로 구현되어 실행되는 것
...
public class 다형성01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("-------조상객체로 자식객체 생성---------");
		
		// 자식의 객체로 조상을 생성하는 것은 불가능함.
...
//		ex1.moveAnimal(d); // animal클래스를 상속받고 있지 않기때문에 불가능
		...
		// 휴먼을 담을 수 있는 자료형의 객체에 = 애니멀 을 상속받은 휴먼 클래스 객체를 담은 케이스
//		 ClassCastException (다운 캐스팅의 잘못된 예시)
		Human human = (Human)hAnimal; 
		human.readBook(); // 캐스팅오류
...
//		
		...
		//instance of : 객체가 해당 클래스의 형에 맞는지 체크하는 메세지
